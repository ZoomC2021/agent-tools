...
main() {
    ...
    echo "  - widereview       : Wide fan-out review across 4 model CLIs (Grok 4.5 + Composer 2.5 Fast + GPT-5.6 Sol + Kimi K3); diff or full-codebase (--full)"
    echo "  - council          : Wide fan-out consultation across 4 model CLIs (Grok 4.5 + Composer 2.5 Fast + GPT-5.6 Sol + Kimi K3); vote-weighted verdict with explicit dissent"
