...
Write-Host "  - Agent-Browser    : Browser automation with the agent-browser CLI"
Write-Host "  - Imagegen-Google  : Generate/edit images with Google Nano Banana Pro (Vertex AI)"
