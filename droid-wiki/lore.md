...
Key events:
- Added Claude Code, Codex, Cursor, Cline, Roo Code support
...
Apr 2025: 15 agent targets, 8+ workflows
...
**Format proliferation**: Supporting 15 agents means maintaining prompts in ~5 different formats (Markdown with frontmatter, SKILL.md, .agent.md, YAML, plain Markdown).
