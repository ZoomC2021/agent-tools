...
|----------|---------|--------------|
| [review](review.md) | Review uncommitted changes for bugs and regressions | All 13 agents |
| [refactor](refactor.md) | Analyze and prioritize refactoring opportunities | All 13 agents |
| [create-pr](create-pr.md) | Create PR with auto-generated title and description | All 13 agents |
| [pr-reviewer](pr-reviewer.md) | Address PR review feedback | All 13 agents |
| [pr-reviewer-only](pr-reviewer-only.md) | Fetch PR comments, generate fix prompts without auto-fixing | All 13 agents |
