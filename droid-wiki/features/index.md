...
|----------|---------|--------------|
| [review](review.md) | Review uncommitted changes for bugs and regressions | All 15 agents |
| [refactor](refactor.md) | Analyze and prioritize refactoring opportunities | All 15 agents |
| [create-pr](create-pr.md) | Create PR with auto-generated title and description | All 15 agents |
| [pr-reviewer](pr-reviewer.md) | Address PR review feedback | All 15 agents |
| [pr-reviewer-only](pr-reviewer-only.md) | Fetch PR comments, generate fix prompts without auto-fixing | All 15 agents |
| [deslop](deslop.md) | Code quality audit against engineering principles | 14 agents |
