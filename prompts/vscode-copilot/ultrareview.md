...
1. **GPT 5.5** - Primary model for reasoning-heavy analysis
...
### Process 1: GPT 5.5 Review (VSCode Copilot)
...
- GPT 5.5 findings (from VSCode Copilot)
- Gemini 3.1 Pro findings (from CLI output)

Handle failures gracefully:
- If GPT 5.5 fails → Use Gemini results alone
- If Gemini CLI fails → Use GPT 5.5 results alone
...
### Both Models Failure
Report: "UltraReview failed: Both GPT 5.5 and Gemini 3.1 Pro unavailable. Use standard /review instead."
