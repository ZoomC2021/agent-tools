---
name: widereview
description: Wide fan-out code review across four cheap-model CLIs (Grok Composer 2.5, Qwen3.7-Max, OpenCode, MiMo v2.5 Pro) run in parallel, then consolidated into a vote-weighted report. Supports diff mode (default) and full-codebase mode (--full).
---
