...
Use this agent when the task depends on inspecting code outside the local workspace, such as:
...
4. When reading files from a snapshot, use line-numbered output so findings cite exact lines
