...
Output a detailed, self-contained prompt that a coding agent can follow to resolve all issues. The prompt must include:
...
**File:** `{path}` (line {line})
**Priority:** {Blocking/Suggestion/Nitpick}
