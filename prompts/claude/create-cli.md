...
- Apply the condensed CLI Guidelines appendix below as the default rubric.
...
_Adapted from [`steipete/agent-scripts`](https://github.com/steipete/agent-scripts), MIT License. See `THIRD_PARTY_LICENSES.md` in the agent-tools repository._
