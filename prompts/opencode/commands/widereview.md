---
description: Wide fan-out code review across four cheap-model CLIs (deepseek-v4-pro, Qwen3.7-Max, FirePass, Gemini 3.5 Flash) run in parallel, then consolidated into a vote-weighted report. Diff mode (default) or full-codebase mode (--full)
mode: subagent
