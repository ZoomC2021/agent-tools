---
description: Wide fan-out code review across three cheap-model CLIs (Grok Composer 2.5, Qwen3.7-Max, FirePass) run in parallel, then consolidated into a vote-weighted report. Diff mode (default) or full-codebase mode (--full)
mode: subagent
