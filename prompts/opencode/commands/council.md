---
description: 'Wide fan-out multi-model consultation across four model CLIs (Grok 4.5 via grok, Composer 2.5 Fast via cursor-agent, GPT-5.6 Sol via codex, and Kimi K3 via cmd) on a single question, consolidated into a vote-weighted council report with explicit dissent. Use for non-review questions: architecture tradeoffs, technology choice, design stress-test, second opinions, "should I do X" decisions.'
mode: subagent
---
