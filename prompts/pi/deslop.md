...
> A comprehensive slash command for identifying and fixing "slop" in your codebase. If you use Pi, drop this file into your `~/.pi/agent/prompts/` folder. Then restart Pi and run `/deslop`.
...
Just download this entire markdown file into your Pi prompt-templates folder, then restart Pi and run `/deslop`.
- `~/.pi/agent/prompts/deslop.md`
...
*This document is designed to be dropped into your `~/.pi/agent/prompts/` folder. Run `/deslop [file-or-directory]` to analyze your code against these principles and let the agent fix any slop it detects.*
